...
ODriveCanNode::ODriveCanNode(const std::string& node_name) : rclcpp::Node(node_name) {
    ...
    "request_axis_state",
    std::bind(&ODriveCanNode::service_callback, this, std::placeholders::_1, std::placeholders::_2),
    srv_qos);

    service_clear_errors_ = this->create_service<Empty>(
    "clear_errors",
    std::bind(&ODriveCanNode::service_clear_errors_callback, this, std::placeholders::_1, std::placeholders::_2),
